    ...
    <div className="relative overflow-hidden bg-gradient-to-b from-white to-voting-lightGray">
      <div className="container mx-auto px-4 py-20 flex flex-col lg:flex-row items-center gap-10">
        <div className="flex-1 space-y-6 max-w-2xl">
          <div className="inline-flex items-center gap-2 py-1 px-3 rounded-full bg-voting-lightBlue text-voting-blue text-sm font-medium animate-fade-in">
          ...
          <div className="flex flex-wrap gap-4 pt-2 animate-slide-up" style={{ animationDelay: '200ms' }}>
            <Link to="/register">
              <Button className="bg-voting-blue hover:bg-voting-blue/90 gap-2">
                Register to Vote
            ...
            <div className="relative bg-white border border-border shadow-lg rounded-lg p-6 overflow-hidden">
              ...
              <div className="space-y-4">
                <div className="p-3 border border-border rounded-md bg-voting-lightGray">
                  <h4 className="text-sm font-medium mb-2">City Council Election 2023</h4>
                  <p className="text-xs text-muted-foreground">Cast your secure vote for your district representative</p>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3 p-2 rounded-md hover:bg-voting-lightGray cursor-pointer">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">District 5 Candidate</div>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-3 p-2 rounded-md bg-voting-lightBlue border border-voting-blue/20">
